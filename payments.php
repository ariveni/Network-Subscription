  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
              <a href="payments.php"  aria-expanded="false" class="dropdown-toggle" style="color:black" >Payments</a>
      ...
      ?>
        ...
        <div class="main" >
            <table>
                ...
                <tbody>
                    <?php
                    $stmt = $conn->prepare('SELECT * FROM payments WHERE admin_id IS NULL');
                    $stmt->execute();
                    ...
                    <tr>
                        ...
                        <td>
                          <form action="paymentupdate.php" method="post" onsubmit="return confirmSubmit('reject')" >
                          <input type="hidden" name="user_id" value="<?php echo $row['user_id']; ?>">
                          <input type="hidden" name="msg" value=1>
                          <input type="hidden" name="price" value="<?php echo $row['price']; ?>">
                          <button type="submit" value="reject" name="button" >reject</button>
                          </form>  
                            
                            <form action="paymentupdate.php?" method="post" onsubmit="return confirmSubmit('approve')" >
                            <input type="hidden" name="user_id" value="<?php echo $row['user_id']; ?>">
                            <input type="hidden" name="msg" value=2>
                            <input type="hidden" name="price" value="<?php echo $row['price']; ?>">
                            <button type="submit" value="reject" name="button" >accept</button>
                          </form> 
                        </td>
                    </tr>
...
function confirmSubmit(msg) {
  var confirmationMessage = "Do you want to " + msg + " payment of  ?";
